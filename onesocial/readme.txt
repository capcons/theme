...
= 1.5.3 =
* Fix - User roles options styling at registration
* Fix - Improved styling of replies when nested option in bbPress is enabled

= 1.5.2 =
* Fix - Image was not clickable on Testimonial widget 
* Fix - Fields styling on Pro Dashbaord page -> Vendor Application
* Fix - Site notice width styling on all template
* Fix - Button taking random styling on Orders page -> Social MarketPlace
* Fix – Replies are not showing properly when nested option in bbPress is enabled

= 1.5.1 =
* Fix - Login page styling after WordPress 5.3 update
* Fix - Some php notices after WordPress 5.3
* Fix - Site Notice issue after BuddyPress update
* Fix - Some dash icon appearing on hover of social icons
* Fix - Social MarketPlace misaligned fields on the checkout page and vendor shop settings page



= 1.5.0 =
* Fix - Site logo disappeared when Search box is enabled for Mobile layout


= 1.4.9 =
* Fix - On mobile device when uploading a new avatar, the crop-panel was zoomed

= 1.4.8 =
* Fix - Notification bubble issues with profile dropdown menu in WordPress 5.2
* Fix - Fixed error with top section of the page hidden on mobile devices
* Fix - Fixed error with social icons getting duplicated in footer
* Fix - Updated template for BuddyPress Global Search plugin
* Fix - Added translation string for 'More' text

= 1.4.7 =
* Fix - Updated template for groups home - removed undefined functions
* Fix - Removed images lazy load as it slows the site
* Fix - Various missing icons fixes after fontawesome update
* Fix - Radio buttons getting cut on Register overlay. 
* Fix - Missing spam icon coming from Akismet Plugin
* Fix - WordPress social login icons not showing on login page
* Fix - Improved Groups widget styling
